...
export const adminStyles = {
  ...
  logo: { display: "flex", alignItems: "center", gap: 10, marginBottom: 26, padding: "0 8px" },
  logoMark: {
  ...
  navLink: {
    display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", color: "rgba(255,255,255,.78)",
  ...
  mainHeader: { display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 16, marginBottom: 6, flexWrap: "wrap" as const },
  ...
  badge: (bg: string, fg: string) => ({ background: bg, color: fg, padding: "3px 11px", fontSize: 12, fontWeight: 600, whiteSpace: "nowrap" as const, display: "inline-block" }),
